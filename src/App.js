...
function App() {
  const [currentPage, setCurrentPage] = useState('login'); // تغيير من 'signup' إلى 'login'
  ...
  // دالة تسجيل الدخول بجوجل الحقيقية
  ...
  // User Info Corner Component - معدل لدعم الضيوف
  ...
  const ChatPage = () => {
    ...
    const handleLogout = useCallback(async () => {
      ...
      setCurrentPage('signup'); // تغيير من 'language' إلى 'signup'
